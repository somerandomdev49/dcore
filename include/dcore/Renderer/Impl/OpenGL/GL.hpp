...
namespace dcore::graphics::impl::opengl
{
	...
	namespace Gl
	{
		...
		inline void SetUniform(UInt loc, const glm::mat2x2 &v) { glUniformMatrix2fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat2x3 &v) { glUniformMatrix2x3fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat2x4 &v) { glUniformMatrix2x4fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat3x2 &v) { glUniformMatrix3x2fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat3x3 &v) { glUniformMatrix3fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat3x4 &v) { glUniformMatrix3x4fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat4x2 &v) { glUniformMatrix4x2fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat4x3 &v) { glUniformMatrix4x3fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
		inline void SetUniform(UInt loc, const glm::mat4x4 &v) { glUniformMatrix4fv(loc, 1, GL_FALSE, glm::value_ptr(v)); }
